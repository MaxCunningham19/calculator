...
def test_validateExpression() -> None:
    tests = [
        ...
        Test("More Ops", [1, "+", "*", 2], "Error: two operators in a row: + and *"),
        ...
        Test("Operator r bracket err", ["(", 56, "*", ")"], "Error: operator before right bracket"),
        Test("Operator l bracket err", ["(", "/", 3, ")"], "Error: operator after left bracket"),

...
def test_validateExpression() -> None:
    tests = [
        ...
        Test("Multi Digits", [1, "*", 21, "-",
             190, "/", 8, "+", 346759], None),
        Test("More Numbers", [1, 1, "+", 1],
        ...
        Test("Left bracket error", [
             "(", 56, "+", 45], "Error: open left bracket"),
        Test("Right bracket error", [56, "+", 45, ")"],
             "Error: open right bracket"),
        Test("Operator r bracket err", [
             "(", 56, "*", ")"], "Error: operator before right bracket"),
        Test("Operator l bracket err", [
             "(", "/", 3, ")"], "Error: operator after left bracket"),
        Test("Invalid character", [34, "?", 45],
